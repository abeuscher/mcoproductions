        ...
        <div class="row">
          ...
          <div class="drop">
            <ul>
              ...
              <li><a class="current" href="/remote-game-info"><span class="fa fa-laptop-house"></span><span class="pagetitle">Remote Game Info</span></a>
              </li>
            </ul>
          </div>
        </div>
    ...
    default:
      ...
      <div class="container-fluid content">
        ...
        <div class="row resources">
          <div class="col-xs-12">
            <h2>Downloads</h2>
            <p><a href="#">10 Question Scoresheet</a></p>
            <p><a href="#">20 Question Scoresheet</a></p>
            <p><a href="#">Answer form for GAME NAME</a></p>
          </div>
        </div>
      </div>
      <footer>
