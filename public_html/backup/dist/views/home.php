  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <nav class="row" id="main-nav">
        ...
        <div class="drop">
          <ul>
            <li><a class="current" href="/home"><span class="fa fa-home"></span><span class="pagetitle">Home</span></a>
            </li>
      ...
      <div class="content row">
        <div class="col-8-m">
          <div class="row vtop">
            ...
            <div class="col-12-m">
              <button class="button cta">Book Trivia or a DJ</button>
            </div>
            <div class="col-12-xs">
            ...
            <div class="col-6-s book-bucket"><img src="../../../../img/book-image.jpg" alt=""></div>
            <div class="col-6-s">
              <div class="block">
                <h2>Press</h2>
